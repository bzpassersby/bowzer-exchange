...
describe('Success',()=>{
   ...
   beforeEach(async ()=>{
    ...
    console.log(deployer.address,feeAccount.address,user1.address)
    console.log(token1.address,exchange.address)
    ...
    console.log(await token1.allowance(user1.address,exchange.address))
